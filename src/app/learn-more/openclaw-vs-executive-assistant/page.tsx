    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 text-slate-900">
      <section className="relative overflow-hidden bg-gradient-to-r from-blue-700 via-indigo-700 to-blue-900 text-white">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-16">
          ...
          <h1 className="mt-3 text-4xl font-bold leading-tight">OpenClaw vs. Hiring an Executive Assistant</h1>
      ...
      <section className="mx-auto max-w-4xl px-6 py-12">
        <article className="rounded-3xl border border-slate-200/70 bg-white p-8 shadow-sm">
          <p className="text-lg leading-relaxed text-slate-700">OpenClaw shines at repeatable, system-driven work: inbox triage, reminders, summaries, and structured workflow execution 24/7.</p>
          <p className="mt-4 leading-relaxed text-slate-600">Human executive assistants remain critical for nuanced judgment, relationship-heavy communication, and sensitive context. Most teams get best results by combining both.</p>
        </article>
      </section>
    </main>
  );
